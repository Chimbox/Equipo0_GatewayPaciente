...
public class CitasClient {
    ...
    public void postActualizarSolicitud(Object requestEntity) throws ClientErrorException {
        webTarget.path("actualizarSolicitud").request(javax.ws.rs.core.MediaType.APPLICATION_JSON).post(javax.ws.rs.client.Entity.entity(requestEntity, javax.ws.rs.core.MediaType.APPLICATION_JSON));
    }
